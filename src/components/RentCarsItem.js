    ...
    return (
        ...
        <div className="car-item-body">
            <div className="content">
                ...
                <span className="price">Price:${props.car.price/10 ** 24} per day</span>
                <p>{props.car.description}</p>
                <a style = {{color: "white"}} onClick = {()=>props.rentCar(props.car.price, props.car.id)} className="cmn-btn">Rent Car</a>
            </div>
